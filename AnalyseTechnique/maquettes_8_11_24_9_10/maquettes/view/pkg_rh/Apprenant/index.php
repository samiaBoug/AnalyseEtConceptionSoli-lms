        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label for="skill">Groupe :</label>
                            <select class="form-control" id="skill">
                                <option value="">Toutes</option>
                                <option value="C1">DMB 101</option>
                                <option value="C2">DWB 101</option>
                                <option value="C3">DWB 102</option>
                                <option value="C4">DWB 103</option>
                                <option value="C5">DWB 104</option>
